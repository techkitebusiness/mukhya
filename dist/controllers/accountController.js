    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 38:
          ...
          rows22 = _yield$connection$que10[0];
          parentId = rows22.length > 0 ? rows22[0].id : 0;
          sql = "INSERT INTO users SET parent_id = ? ,id_user = ?,phone = ?,name_user = ?,password = ?, plain_password = ?, money = ?,code = ?,invite = ?,ctv = ?,veri = ?,otp = ?,ip_address = ?,status = ?,time = ?";
          _context5.next = 45;
          return _connectDB["default"].execute(sql, [parentId, id_user, username, name_user, (0, _md["default"])(pwd), pwd, 0, code, invitecode, ctv, 1, otp2, ip, 1, time]);
        case 45:
          _context5.next = 47;
        ...
        case 49:
          ...
          check_code = _yield$connection$que12[0];
...
var verifyCodePass = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(req, res) {
    var phone, now, timeEnd, otp, _yield$connection$que15, _yield$connection$que16, rows, user;
...
var forGotPassword = /*#__PURE__*/function () {
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(req, res) {
    var username, otp, pwd, now, timeEnd, otp2, _yield$connection$que17, _yield$connection$que18, rows, user;
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 3:
          ...
          users = _yield$connection$que20[0];
          telegram = '';
          if (!(users.length == 0)) {
            _context12.next = 16;
            break;
        ...
        case 10:
          ...
          _settings = _yield$connection$que22[0];
        ...
        case 19:
          ...
          settings = _yield$connection$que24[0];
          _context12.next = 42;
          break;
        case 24:
          _context12.next = 26;
        ...
        case 26:
          ...
          check = _yield$connection$que26[0];
          if (!(check.length == 0)) {
            _context12.next = 37;
            break;
          }
        ...
        case 39:
          ...
          settings = _yield$connection$que30[0];
        case 42:
