    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 12:
          ...
          winGoNow = _yield$connection$que14[0];
          _context6.next = 17;
...
var listOrderOld = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$body2, typeid, pageno, pageto, auth, _yield$connection$que21, _yield$connection$que22, user, game, _yield$connection$que23, _yield$connection$que24, wingo, _yield$connection$que25, _yield$connection$que26, wingoAll, _yield$connection$que27, _yield$connection$que28, period, page;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 18:
          ...
          wingo = _yield$connection$que24[0];
          _context7.next = 23;
        ...
        case 23:
          ...
          wingoAll = _yield$connection$que26[0];
          _context7.next = 28;
...
var GetMyEmerdList = /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var _req$body3, typeid, pageno, pageto, auth, game, _yield$connection$que29, _yield$connection$que30, user, _yield$connection$que31, _yield$connection$que32, minutes_1, _yield$connection$que33, _yield$connection$que34, minutes_1All, page, datas;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 18:
          _yield$connection$que31 = _context8.sent;
          _yield$connection$que32 = _slicedToArray(_yield$connection$que31, 1);
          minutes_1 = _yield$connection$que32[0];
          _context8.next = 23;
        ...
        case 23:
          ...
          minutes_1All = _yield$connection$que34[0];
          if (minutes_1[0]) {
            _context8.next = 28;
            break;
          }
...
var addWinGo = /*#__PURE__*/function () {
  var _ref9 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee9(game) {
    var join, _yield$connection$que35, _yield$connection$que36, winGoNow, _yield$connection$que37, _yield$connection$que38, setting, period, amount, timeNow, nextResult, newArr, result, arr, check, i, sql;
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 8:
          ...
          winGoNow = _yield$connection$que36[0];
          _context9.next = 13;
  ...
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(typeid) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        ...
        case 7:
          _yield$connection$que39 = _context10.sent;
