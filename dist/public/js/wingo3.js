...
$(".con-box button").click(function (e) {
  e.preventDefault();
  var addTop = $(this).attr("data-join"); // Green - do - tim (x - d - t)
  var addText = $(this).text(); // Green - do - tim
  alertBox(addTop, addText);
});
$(".number-box button").click(function (e) {
  e.preventDefault();
  var addTop = $(this).text().trim(); // Green - do - tim (x - d - t)
  var addText = $(this).text(); // Green - do - tim
  alertBox(addTop, addText);
});
