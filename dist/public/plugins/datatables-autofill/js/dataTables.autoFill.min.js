  ...
  c.extend(r.prototype, {
    ...
    _editor: function _editor(a) {
      var d = this.s.dt,
        b = this.c.editor;
      if (b) {
        for (var e = {}, f = [], m = b.fields(), n = 0, p = a.length; n < p; n++) for (var q = 0, v = a[n].length; q < v; q++) {
          var u = a[n][q],
    ...
    _range: function _range(a, d) {
      var b = [];
      if (a <= d) for (; a <= d; a++) b.push(a);else for (; a >= d; a--) b.push(a);
      return b;
    },
    ...
    _update: function _update(a, d) {
      if (!1 !== a) {
        ...
        if (null !== this.c.update ? this.c.update : !this.c.editor) {
          for (var e = 0, f = d.length; e < f; e++) for (var m = 0, n = d[e].length; m < n; m++) {
            var p = d[e][m];
