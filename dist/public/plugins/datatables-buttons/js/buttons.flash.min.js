...
(function (f) {
  ...
  function t(a, b, c) {
    ...
    c && (c.attr && f(d).attr(c.attr), c.children && f.each(c.children, function (g, e) {
      d.appendChild(e);
  ...
  function K(a) {
    ...
    f.each(a, function (b, c) {
      if (f.isPlainObject(c)) K(c);else {
        ...
        E && (-1 === c.indexOf("<?xml") && (c = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>' + c), c = c.replace(/_dt_b_namespace_token_/g, ":"));
  ...
  l.Client.prototype = {
    ...
    receiveEvent: function receiveEvent(a, b) {
      ...
      if (this.handlers[a]) for (var d = 0, g = this.handlers[a].length; d < g; d++) {
  ...
  var L = function L(a, b) {
    ...
    I = "";
  I = "undefined" === typeof q.XMLSerializer ? new function () {
        ...
        v = function v(k) {
          ...
          for (var h = 0, B = k.length; h < B; h++) {
            ...
            if (null !== k[h] && k[h] !== y && "" !== k[h]) {
              ...
              x || ("number" === typeof k[h] || k[h].match && k[h].match(/^-?\d+(\.\d+)?$/) && !k[h].match(/^0\d+/) ? x = t(e, "c", {
                attr: {
                  t: "n",
                  r: u
                },
