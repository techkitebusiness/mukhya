...
$jscomp.polyfillIsolated = function (c, h, k, m) {
  ...
  null != h && (c ? $jscomp.defineProperty($jscomp.polyfills, n, {
    ...
    writable: !0,
    value: h
  }) : h !== k && ($jscomp.propertyToPolyfillSymbol[n] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(n) : $jscomp.POLYFILL_PREFIX + n, n = $jscomp.propertyToPolyfillSymbol[n], $jscomp.defineProperty(m, n, {
    configurable: !0,
    writable: !0,
    value: h
  })));
...
(function (c) {
  ...
  }) : "object" === (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = function (h, k) {
    h || (h = window);
  ...
  c.extend(t.prototype, {
    ...
    _clipboard: function _clipboard() {
      ...
      h.getSelection && (c(k).on("copy" + e, function (d) {
        ...
        d = b.c.editor;
        var g;
        !p || l && "body" !== l.nodeName.toLowerCase() || (f.preventDefault(), h.clipboardData && h.clipboardData.getData ? g = h.clipboardData.getData("Text") : f.clipboardData && f.clipboardData.getData && (g = f.clipboardData.getData("text/plain")), d ? (f = b._inlineOptions(p.cell.index()), d.inline(f.cell, f.field, f.options).set(d.displayed()[0], g).submit()) : (p.cell.data(g), a.draw(!1)));
      }));
    },
    ...
    _editor: function _editor(a, b, e) {
    ...
    _inlineOptions: function _inlineOptions(a) {
    ...
    _focus: function _focus(a, b, e, d) {
      var f = this,
        p = this.s.dt,
        l = p.page.info(),
        g = this.s.lastFocus;
      ...
      if (this.s.enable) {
        ...
        if (-1 !== l.length && (a < l.start || a >= l.start + l.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, p.one("draw", function () {
          ...
          if (e === m || !0 === e) this._scroll(c(h), c(k.body), g, "offset"), e = p.table().body().parentNode, e !== p.table().header().parentNode && (e = c(e.parentNode), this._scroll(e, e, g, "position"));
          this.s.lastFocus = {
            cell: l,
            node: l.node(),
            relative: {
    ...
    _scroll: function _scroll(a, b, e, d) {
      var f = e[d](),
        p = e.outerHeight(),
        l = e.outerWidth(),
        g = b.scrollTop(),
