...
var $jscomp$lookupPolyfilledValue = function $jscomp$lookupPolyfilledValue(c, f) {
...
$jscomp.polyfillIsolated = function (c, f, g, h) {
  ...
  f = f(g);
  null != f && (c ? $jscomp.defineProperty($jscomp.polyfills, k, {
    configurable: !0,
    writable: !0,
    value: f
  }) : f !== g && ($jscomp.propertyToPolyfillSymbol[k] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(k) : $jscomp.POLYFILL_PREFIX + k, k = $jscomp.propertyToPolyfillSymbol[k], $jscomp.defineProperty(h, k, {
    configurable: !0,
    writable: !0,
    value: f
  })));
...
(function (c) {
  ...
  c.extend(m.prototype, {
    ...
    construct: function construct() {
      ...
      if (this.s.dt.oFeatures.bPaginate) {
        ...
        b.on("stateSaveParams.scroller", function (l, n, p) {
          d && e ? (p.scroller = e.scroller, d = !1) : p.scroller = {
    ...
    _draw: function _draw() {
      ...
      this.s.skip = !1;
      this.s.dt.oFeatures.bStateSave && null !== this.s.dt.oLoadedState && "undefined" != typeof this.s.dt.oLoadedState.scroller ? ((b = !this.s.dt.sAjaxSource && !a.s.dt.ajax || this.s.dt.oFeatures.bServerSide ? !1 : !0) && 2 == this.s.dt.iDraw || !b && 1 == this.s.dt.iDraw) && setTimeout(function () {
