...
(function () {
  ...
  var Criteria = /** @class */function () {
    function Criteria(table, opts, topGroup, index, depth) {
      ...
      this.dom = {
        ...
        conditionTitle: $$2('<option value="" disabled selected hidden/>').html(this.s.dt.i18n('searchBuilder.condition', i18n.condition)),
        ...
        dataTitle: $$2('<option value="" disabled selected hidden/>').html(this.s.dt.i18n('searchBuilder.data', i18n.data)),
        defaultValue: $$2('<select disabled/>').addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.select).addClass(this.classes.italic),
        "delete": $$2('<button/>').html(this.s.dt.i18n('searchBuilder.delete', i18n["delete"])).addClass(this.classes["delete"]).addClass(this.classes.button).attr('title', this.s.dt.i18n('searchBuilder.deleteTitle', i18n.deleteTitle)).attr('type', 'button'),
        // eslint-disable-next-line no-useless-escape
        left: $$2('<button/>').html(this.s.dt.i18n('searchBuilder.left', i18n.left)).addClass(this.classes.left).addClass(this.classes.button).attr('title', this.s.dt.i18n('searchBuilder.leftTitle', i18n.leftTitle)).attr('type', 'button'),
        // eslint-disable-next-line no-useless-escape
        right: $$2('<button/>').html(this.s.dt.i18n('searchBuilder.right', i18n.right)).addClass(this.classes.right).addClass(this.classes.button).attr('title', this.s.dt.i18n('searchBuilder.rightTitle', i18n.rightTitle)).attr('type', 'button'),
        ...
        valueTitle: $$2('<option value="--valueTitle--" disabled selected hidden/>').html(this.s.dt.i18n('searchBuilder.value', i18n.value))
      };
    ...
    Criteria.prototype.rebuild = function (loadedCriteria) {
      ...
      if (loadedCriteria.data !== undefined) {
        ...
        this.dom.data.children('option').each(function () {
          if (!foundData && ($$2(this).text() === loadedCriteria.data || loadedCriteria.origData && $$2(this).prop('origData') === loadedCriteria.origData)) {
    ...
    Criteria.prototype._adjustCriteria = function () {
      ...
      if ((buttonsLeft - valRight < 15 || hasLeft && leftOffset.top !== clearOffset.top || hasRight && rightOffset.top !== clearOffset.top) && !this.dom.container.parent().hasClass(this.classes.vertical)) {
        this.dom.container.parent().addClass(this.classes.vertical);
        this.s.topGroup.trigger('dtsb-redrawContents');
      } else if (buttonsLeft - (this.dom.data.offset().left + this.dom.data.outerWidth(true) + this.dom.condition.outerWidth(true) + valWidth) > 15 && this.dom.container.parent().hasClass(this.classes.vertical)) {
    ...
    Criteria.prototype._clearValue = function () {
      if (this.s.condition !== undefined) {
        ...
        var _loop_2 = function _loop_2(val) {
          if (val !== undefined) {
            // Timeout is annoying but because of IOS
            setTimeout(function () {
              val.remove();
      ...
      this.s.value = [];
      this.dom.value = [$$2('<select disabled/>').addClass(this.classes.value).addClass(this.classes.dropDown).addClass(this.classes.italic).addClass(this.classes.select).append(this.dom.valueTitle.clone())];
    };
    /**
    ...
    Criteria.prototype._populateCondition = function () {
      ...
      if (conditionsLength === 0) {
        ...
        var conditionObj = this.c.conditions[this.s.type] !== undefined ? this.c.conditions[this.s.type] : this.s.type.includes('moment') ? this.c.conditions.moment : this.s.type.includes('luxon') ? this.c.conditions.luxon : this.c.conditions.string;
    ...
    Criteria.prototype._populateData = function () {
      ...
      if (this.s.dataPoints.length === 0) {
        this.s.dt.columns().every(function (index) {
          ...
          if (_this.c.columns === true || _this.s.dt.columns(_this.c.columns).indexes().toArray().includes(index)) {
            var found = false;
            ...
            if (!found) {
              ...
              _this.dom.data.append($$2('<option>', {
                text: opt.text,
                value: opt.index
              }).addClass(_this.classes.option).addClass(_this.classes.notItalic).prop('origData', col.data).prop('selected', _this.s.dataIdx === opt.index ? true : false));
      ...
      // Otherwise we can just load them in
        ...
        var _loop_3 = function _loop_3(data) {
          ...
          var newOpt = $$2('<option>', {
            ...
            value: data.index
          }).addClass(this_1.classes.option).addClass(this_1.classes.notItalic).prop('origData', data.origData);
    ...
    Criteria.prototype._populateValue = function (loadedCriteria) {
      ...
      var _loop_4 = function _loop_4(val) {
        // Timeout is annoying but because of IOS
        setTimeout(function () {
          if (val !== undefined) {
            val.remove();
    ...
    Criteria.initSelect = function (that, fn, preDefined, array) {
      ...
      var el = $$2('<select/>').addClass(Criteria.classes.value).addClass(Criteria.classes.dropDown).addClass(Criteria.classes.italic).addClass(Criteria.classes.select).append(that.dom.valueTitle).on('change.dtsb', function () {
      ...
      for (var _i = 0, indexArray_1 = indexArray; _i < indexArray_1.length; _i++) {
        ...
        var addOption = function addOption(filt, text) {
    ...
    Criteria.initInput = function (that, fn, preDefined) {
      ...
      var el = $$2('<input/>').addClass(Criteria.classes.value).addClass(Criteria.classes.input).on('input.dtsb keypress.dtsb', that._throttle(function (e) {
    ...
    Criteria.init2Input = function (that, fn, preDefined) {
      ...
      var searchDelay = that.s.dt.settings()[0].searchDelay;
      var els = [$$2('<input/>').addClass(Criteria.classes.value).addClass(Criteria.classes.input).on('input.dtsb keypress.dtsb', that._throttle(function (e) {
        var code = e.keyCode || e.which;
        if (!that.c.enterSearch && !(that.s.dt.settings()[0].oInit.search !== undefined && that.s.dt.settings()[0].oInit.search["return"]) || code === 13) {
          return fn(that, this);
        }
      }, searchDelay === null ? 100 : searchDelay)), $$2('<span>').addClass(that.classes.joiner).html(that.s.dt.i18n('searchBuilder.valueJoiner', that.c.i18n.valueJoiner)), $$2('<input/>').addClass(Criteria.classes.value).addClass(Criteria.classes.input).on('input.dtsb keypress.dtsb', that._throttle(function (e) {
        var code = e.keyCode || e.which;
        if (!that.c.enterSearch && !(that.s.dt.settings()[0].oInit.search !== undefined && that.s.dt.settings()[0].oInit.search["return"]) || code === 13) {
          return fn(that, this);
        }
    ...
    Criteria.initDate = function (that, fn, preDefined) {
      ...
      var el = $$2('<input/>').addClass(Criteria.classes.value).addClass(Criteria.classes.input).dtDateTime({
        ...
        return fn(that, this);
      }, searchDelay === null ? 100 : searchDelay)).on('input.dtsb keypress.dtsb', that.c.enterSearch || that.s.dt.settings()[0].oInit.search !== undefined && that.s.dt.settings()[0].oInit.search["return"] ? function (e) {
    ...
    Criteria.init2Date = function (that, fn, preDefined) {
      ...
      var els = [$$2('<input/>').addClass(Criteria.classes.value).addClass(Criteria.classes.input).dtDateTime({
        ...
        fn(that, _this);
      }).on('input.dtsb keypress.dtsb', !that.c.enterSearch && !(that.s.dt.settings()[0].oInit.search !== undefined && that.s.dt.settings()[0].oInit.search["return"]) && searchDelay !== null ? that.s.dt.settings()[0].oApi._fnThrottle(function () {
        return fn(that, this);
      }, searchDelay) : that.c.enterSearch || that.s.dt.settings()[0].oInit.search !== undefined && that.s.dt.settings()[0].oInit.search["return"] ? function (e) {
        var code = e.keyCode || e.which;
        if (code === 13) {
          fn(that, _this);
        }
        ...
        fn(that, _this);
      }), $$2('<span>').addClass(that.classes.joiner).html(that.s.dt.i18n('searchBuilder.valueJoiner', that.c.i18n.valueJoiner)), $$2('<input/>').addClass(Criteria.classes.value).addClass(Criteria.classes.input).dtDateTime({
        attachTo: 'input',
        format: that.s.dateFormat ? that.s.dateFormat : undefined
      }).on('change.dtsb', searchDelay !== null ? that.s.dt.settings()[0].oApi._fnThrottle(function () {
        return fn(that, this);
    ...
    Criteria.momentDateConditions = {
      '=': {
        ...
        inputValue: Criteria.inputValueInput,
        isInputValid: Criteria.isInputValidInput,
        search: function search(value, comparison, that) {
  ...
  var Group = /** @class */function () {
    function Group(table, opts, topGroup, index, isChild, depth) {
      ...
      this.dom = {
        ...
        logic: $$1('<button><div/></button>').addClass(this.classes.logic).addClass(this.classes.button).attr('type', 'button'),
  ...
  var SearchBuilder = /** @class */function () {
    ...
    SearchBuilder.prototype._applyPreDefDefaults = function (preDef) {
      ...
      var _loop_1 = function _loop_1(crit) {
    ...
    $.fn.dataTable.ext.buttons.searchBuilder = {
      ...
      init: function init(dt, node, config) {
        var sb = new $.fn.dataTable.SearchBuilder(dt, $.extend({
          filterChanged: function filterChanged(count, text) {
