...
var $jscomp$lookupPolyfilledValue = function $jscomp$lookupPolyfilledValue(k, m) {
...
$jscomp.polyfillIsolated = function (k, m, l, h) {
  ...
  null != m && (k ? $jscomp.defineProperty($jscomp.polyfills, p, {
    ...
    writable: !0,
    value: m
  }) : m !== l && ($jscomp.propertyToPolyfillSymbol[p] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(p) : $jscomp.POLYFILL_PREFIX + p, p = $jscomp.propertyToPolyfillSymbol[p], $jscomp.defineProperty(h, p, {
    configurable: !0,
    writable: !0,
    value: m
  })));
...
(function () {
    ...
    r = function () {
      function c(a, b, d, e, f) {
        ...
        this.dom = {
          ...
          "delete": h("<button/>").html(this.s.dt.i18n("searchBuilder.delete", b["delete"])).addClass(this.classes["delete"]).addClass(this.classes.button).attr("title", this.s.dt.i18n("searchBuilder.deleteTitle", b.deleteTitle)).attr("type", "button"),
          ...
          right: h("<button/>").html(this.s.dt.i18n("searchBuilder.right", b.right)).addClass(this.classes.right).addClass(this.classes.button).attr("title", this.s.dt.i18n("searchBuilder.rightTitle", b.rightTitle)).attr("type", "button"),
      ...
      c.prototype.search = function (a, b) {
        ...
        if (void 0 !== this.s.condition && void 0 !== d) {
          ...
          if (this.s.type.includes("num") && ("" !== this.s.dt.settings()[0].oLanguage.sDecimal || "" !== this.s.dt.settings()[0].oLanguage.sThousands)) {
            ...
            if ("" !== this.s.dt.settings()[0].oLanguage.sThousands) for (a = 0; a < e.length; a++) e[a] = e[a].replace(this.s.dt.settings()[0].oLanguage.sThousands, ",");
            e = e.join(".");
          }
          ...
          if ("array" === this.s.type) for (Array.isArray(e) || (e = [e]), e.sort(), b = 0, a = e; b < a.length; b++) {
            var f = a[b];
      ...
      c.prototype.getDetails = function (a) {
        void 0 === a && (a = !1);
        if (null !== this.s.type && this.s.type.includes("num") && ("" !== this.s.dt.settings()[0].oLanguage.sDecimal || "" !== this.s.dt.settings()[0].oLanguage.sThousands)) for (a = 0; a < this.s.value.length; a++) {
          ...
          if ("" !== this.s.dt.settings()[0].oLanguage.sThousands) for (var d = 0; d < b.length; d++) b[d] = b[d].replace(this.s.dt.settings()[0].oLanguage.sThousands, ",");
          this.s.value[a] = b.join(".");
        } else if (null !== this.s.type && a) if (this.s.type.includes("date") || this.s.type.includes("time")) for (a = 0; a < this.s.value.length; a++) null === this.s.value[a].match(/^\d{4}-([0]\d|1[0-2])-([0-2]\d|3[01])$/g) && (this.s.value[a] = "");else if (this.s.type.includes("moment")) for (a = 0; a < this.s.value.length; a++) this.s.value[a] = t(this.s.value[a], this.s.dateFormat).toISOString();else if (this.s.type.includes("luxon")) for (a = 0; a < this.s.value.length; a++) this.s.value[a] = v.DateTime.fromFormat(this.s.value[a], this.s.dateFormat).toISO();
        if (this.s.type.includes("num") && this.s.dt.page.info().serverSide) for (a = 0; a < this.s.value.length; a++) this.s.value[a] = this.s.value[a].replace(/[^0-9.]/g, "");
        return {
        ...
        this.dom.condition.unbind("change").on("change.dtsb", function () {
          ...
          for (var b = a.dom.condition.children("option." + a.classes.option), d = 0; d < b.length; d++) {
            ...
            if (e.val() === a.dom.condition.val()) {
              ...
              e.prop("selected", !0);
              e = e.val();
              for (var f = 0, g = Object.keys(a.s.conditions); f < g.length; f++) if (g[f] === e) {
                a.s.condition = e;
                break;
              }
              a._clearValue();
      ...
      c.prototype._clearValue = function () {
        if (void 0 !== this.s.condition) {
          if (0 < this.dom.value.length && void 0 !== this.dom.value[0]) for (var a = function a(f) {
          ...
          if (0 < this.dom.value.length && void 0 !== this.dom.value[0]) for (this.dom.value[0].insertAfter(this.dom.condition).trigger("dtsb-inserted"), e = 1; e < this.dom.value.length; e++) this.dom.value[e].insertAfter(this.dom.value[e - 1]).trigger("dtsb-inserted");
        } else {
          a = function a(f) {
            void 0 !== f && setTimeout(function () {
              f.remove();
      ...
      c.prototype._populateCondition = function () {
        ...
        if (0 === b) {
          ...
          if (void 0 !== d) if (d = d[b], void 0 !== d.searchBuilderType && null !== d.searchBuilderType) this.s.type = d.searchBuilderType;else if (void 0 === this.s.type || null === this.s.type) this.s.type = d.sType;
        ...
        } else if (0 < b) for (this.dom.condition.empty().removeAttr("disabled").addClass(this.classes.italic), e = 0, f = Object.keys(this.s.conditions); e < f.length; e++) d = f[e], b = this.s.conditions[d].conditionName, "function" === typeof b && (b = b(this.s.dt, this.c.i18n)), d = h("<option>", {
          text: b,
          value: d
        }).addClass(this.classes.option).addClass(this.classes.notItalic), void 0 !== this.s.condition && this.s.condition === b && (d.prop("selected", !0), this.dom.condition.removeClass(this.classes.italic)), a.push(d);else {
      ...
      c.prototype._populateData = function () {
        ...
        if (0 === this.s.dataPoints.length) this.s.dt.columns().every(function (g) {
          if (!0 === a.c.columns || a.s.dt.columns(a.c.columns).indexes().toArray().includes(g)) {
            for (var n = !1, q = 0, u = a.s.dataPoints; q < u.length; q++) if (u[q].index === g) {
              n = !0;
              break;
            }
      ...
      c.prototype._populateValue = function (a) {
        ...
        this.setListeners();
        d !== this.s.filled && (this.s.dt.page.info().serverSide || this.s.dt.draw(), this.setListeners());
      };
      ...
      c.initSelect = function (a, b, d, e) {
        ...
        for (var u = [], D = [], H = 0; H < g.length; H++) {
          ...
          z = n.oApi._fnGetCellData(n, z, f, "string" === typeof a.c.orthogonal ? a.c.orthogonal : a.c.orthogonal.display);
          "array" === a.s.type && (A = Array.isArray(A) ? A : [A], z = Array.isArray(z) ? z : [z]);
          var J = function J(w, y) {
            ...
            y = w.val();
            -1 === u.indexOf(y) && (u.push(y), D.push(w), null !== d && Array.isArray(d[0]) && (d[0] = d[0].sort().join(",")), null !== d && w.val() === d[0] && (w.prop("selected", !0), q.removeClass(c.classes.italic), a.dom.valueTitle.removeProp("selected")));
          };
      ...
      c.updateListener = function (a, b) {
        ...
        if (a.s.filled) {
          ...
          for (d = 0; d < a.s.value.length; d++) if (Array.isArray(a.s.value[d])) a.s.value[d].sort();else if (a.s.type.includes("num") && ("" !== a.s.dt.settings()[0].oLanguage.sDecimal || "" !== a.s.dt.settings()[0].oLanguage.sThousands)) {
            var e = [a.s.value[d].toString()];
            "" !== a.s.dt.settings()[0].oLanguage.sDecimal && (e = a.s.value[d].split(a.s.dt.settings()[0].oLanguage.sDecimal));
            if ("" !== a.s.dt.settings()[0].oLanguage.sThousands) for (var f = 0; f < e.length; f++) e[f] = e[f].replace(a.s.dt.settings()[0].oLanguage.sThousands, ",");
            a.s.value[d] = e.join(".");
          }
          f = e = null;
          for (d = 0; d < a.dom.value.length; d++) b === a.dom.value[d][0] && (e = d, void 0 !== b.selectionStart && (f = b.selectionStart));
          a.s.dt.draw();
      ...
      c.dateConditions = {
        "=": {
          conditionName: function conditionName(a, b) {
    ...
    G = function () {
      function c(a, b, d, e, f, g) {
        ...
        this.dom = {
          ...
          clear: B("<button>&times</button>").addClass(this.classes.button).addClass(this.classes.clearGroup).attr("type", "button"),
      ...
      c.prototype.rebuild = function (a) {
        if (!(void 0 === a.criteria || null === a.criteria || Array.isArray(a.criteria) && 0 === a.criteria.length)) {
          ...
          if (Array.isArray(a.criteria)) for (var b = 0, d = a.criteria; b < d.length; b++) a = d[b], void 0 !== a.logic ? this._addPrevGroup(a) : void 0 === a.logic && this._addPrevCriteria(a);
          b = 0;
      ...
      c.prototype.setupLogic = function () {
        ...
        if (1 > this.s.criteria.length) this.s.isChild || (this.dom.container.trigger("dtsb-destroy"), this.dom.container.css("margin-left", 0));else {
      ...
      c.prototype.addCriteria = function (a, b) {
        ...
        e.populate();
        a = !1;
        for (var f = 0; f < this.s.criteria.length; f++) 0 === f && this.s.criteria[f].criteria.s.index > e.s.index ? (e.getNode().insertBefore(this.s.criteria[f].criteria.dom.container), a = !0) : f < this.s.criteria.length - 1 && this.s.criteria[f].criteria.s.index < e.s.index && this.s.criteria[f + 1].criteria.s.index > e.s.index && (e.getNode().insertAfter(this.s.criteria[f].criteria.dom.container), a = !0);
      ...
      c.prototype._removeCriteria = function (a, b) {
        void 0 === b && (b = !1);
        if (1 >= this.s.criteria.length && this.s.isChild) this.destroy();else {
    ...
    I = function () {
      function c(a, b) {
        ...
        if (void 0 === a.settings()[0]._searchBuilder) {
          ...
          if (this.s.dt.settings()[0]._bInitComplete) this._setUp();else a.one("init.dt", function () {
            d._setUp();
          });
          return this;
        }
      ...
      c.prototype._setUp = function (a) {
        ...
        if (!C.DateTime) {
          ...
          for (f = 0; f < e[0].length; f++) if (g = d[e[0][f]], (!0 === this.c.columns || Array.isArray(this.c.columns) && this.c.columns.includes(f)) && (g.includes("date") || g.includes("moment") || g.includes("luxon"))) throw alert("SearchBuilder Requires DateTime when used with dates."), Error("SearchBuilder requires DateTime");
        }
        ...
        a && (a = this.s.dt.state.loaded(), null !== a && void 0 !== a.searchBuilder ? (this.s.topGroup.rebuild(a.searchBuilder), this.s.topGroup.dom.container.trigger("dtsb-redrawContents"), this.s.dt.page.info().serverSide || this.s.dt.page(a.page).draw("page"), this.s.topGroup.setListeners()) : !1 !== this.c.preDefined && (this.c.preDefined = this._applyPreDefDefaults(this.c.preDefined), this.rebuild(this.c.preDefined)));
      ...
      c.prototype._collapseArray = function (a) {
        ...
        }), a.value1 = a.value[0], a.value2 = a.value[1]);else for (var b = 0; b < a.criteria.length; b++) a.criteria[b] = this._collapseArray(a.criteria[b]);
        return a;
      };
  ...
  (function (c) {
    ...
    c.fn.dataTable.ext.buttons.searchBuilder = {
      action: function action(f, g, n, q) {
      ...
      config: {},
      init: function init(f, g, n) {
        var q = new c.fn.dataTable.SearchBuilder(f, c.extend({
          filterChanged: function filterChanged(u, D) {
            f.button(g).text(D);
          }
        }, n.config));
