  ...
  var SearchPane = /** @class */function () {
    ...
    SearchPane.prototype._search = function (filter, dataIndex) {
      ...
      for (var _i = 0, _a = this.selections; _i < _a.length; _i++) {
        ...
        !(typeof filter === 'string' && filter.length === 0) && filter == colSelect.filter || colSelect.filter === null && typeof filter === 'string' && filter === '') {
          return true;
        }
      }
      // If the combiner is an and then we need to check against all possible selections
        ...
        if (this.colExists) {
          ...
          var _loop_1 = function _loop_1(dataP) {
            ...
            if (dataP && (rowData.bins[dataP.filter] !== undefined && rowData.bins[dataP.filter] !== 0 && this_1.c.cascadePanes || !this_1.c.cascadePanes || this_1.s.clearing)) {
              var row = this_1.addRow(dataP.display, dataP.filter, !this_1.c.viewTotal ? rowData.bins[dataP.filter] : rowData.bins[dataP.filter] !== undefined ? rowData.bins[dataP.filter] : 0, this_1.c.viewTotal ? String(rowData.binsTotal[dataP.filter]) : rowData.bins[dataP.filter], dataP.sort, dataP.type);
      ...
      for (var _h = 0, _j = this.s.panes; _h < _j.length; _h++) {
        ...
        if (pane !== undefined && pane.s.dtPane !== undefined && (pane.s.colOpts.preSelect !== undefined && pane.s.colOpts.preSelect.length > 0 || pane.customPaneSettings !== null && pane.customPaneSettings.preSelect !== undefined && pane.customPaneSettings.preSelect.length > 0)) {
          ...
          for (var i = 0; i < tableLength; i++) {
            if (pane.s.colOpts.preSelect.includes(pane.s.dtPane.cell(i, 0).data()) || pane.customPaneSettings !== null && pane.customPaneSettings.preSelect !== undefined && pane.customPaneSettings.preSelect.includes(pane.s.dtPane.cell(i, 0).data())) {
