    ...
    i = [r(2)], void 0 === (n = function (t) {
      ...
      var yt = e.pathBBox = function (t) {
        ...
        At = (e._parseDots = ht(function (t) {
          ...
          for (i = 1, n = r.length - 1; i < n; i++) if (!r[i].offset) {
            for (var o = F(r[i - 1].offset || 0), l = 0, h = i + 1; h < n; h++) if (r[h].offset) {
              l = r[h].offset;
              break;
            }
            l || (l = 100, h = n);
      ...
      for (var Ft = function Ft() {
          ...
          if (t.addEventListener(e, n, !1), p && m[e]) {
            var a = function a(e) {
              for (var n = qt(e), a = e, s = 0, o = e.targetTouches && e.targetTouches.length; s < o; s++) if (e.targetTouches[s].target == t) {
      ...
      function ae(r, i, a, s, l, h) {
        ...
        if (u) {
          if (c) c.initstatus = s, c.start = new Date() - c.ms * s;else {
            for (var S in u) if (u[o](S) && (q[o](S) || i.paper.customAttributes[o](S))) switch (b[S] = i.attr(S), null == b[S] && (b[S] = j[S]), _[S] = u[S], q[S]) {
              case T:
                w[S] = (_[S] - b[S]) / m;
                break;
              case "colour":
      ...
      return fe.attr = function (t, r) {
        ...
        if (this.fonts[r] ? this.fonts[r].push(e) : this.fonts[r] = [e], !t.svg) for (var n in e.face["units-per-em"] = z(t.face["units-per-em"], 10), t.glyphs) if (t.glyphs[o](n)) {
          var a = t.glyphs[n];
          if (e.glyphs[n] = {
            w: a.w,
            k: {},
